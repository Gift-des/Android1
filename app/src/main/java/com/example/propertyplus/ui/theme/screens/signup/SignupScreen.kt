...
fun SignupScreen(navController: NavController){
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .paint(painterResource(id = R.drawable.background3), contentScale = ContentScale.FillBounds),
...

    {
        ...
        OutlinedTextField(
            ...
            leadingIcon = { Icon(imageVector = Icons.Default.Person, contentDescription = "", tint = midnight)},
        ...
        OutlinedTextField(
            ...
            modifier = Modifier.fillMaxWidth().padding(start = 20.dp, end = 20.dp),
            leadingIcon = { Icon(imageVector = Icons.Default.Email, contentDescription = "", tint = midnight)},
        ...
        OutlinedTextField(
            ...
            modifier = Modifier.fillMaxWidth().padding(start = 20.dp, end = 20.dp),
            leadingIcon = { Icon(imageVector = Icons.Default.Lock, contentDescription = "", tint = midnight)},
